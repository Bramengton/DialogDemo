 ...
 * @date 01.12.17.
 */
public abstract class Fields2Compat extends DialogFragment {
...
//    private int mChoiceMode = AbsListView.CHOICE_MODE_NONE;
    ...
    public Fields2Compat setMessage(@StringRes int resId, Object... formatArgs) {
        mMessageRes = resId;
        mMessageArgs = formatArgs;
        return this;
    }

    public Fields2Compat setMessage(@StringRes int resId) {
        mMessageRes = resId;
        return this;
    }

    public Fields2Compat setMessage(CharSequence message) {
        mMessageChar = message;
        return this;
    }

    public Fields2Compat setTitle(@StringRes int resId, Object... formatArgs) {
        mTitleRes = resId;
        mTitleArgs = formatArgs;
        return this;
    }

    public Fields2Compat setTitle(@StringRes int resId) {
        mTitleRes = resId;
        return this;
    }

    public Fields2Compat setTitle(CharSequence title) {
        mTitleChar = title;
        return this;
    }
    ...
    public CharSequence getTitleChar() {
        if((mTitleChar==null || mTitleChar.length()<=0) && (mTitleRes>0))
            mTitleChar = mResources.getString(mTitleRes, mTitleArgs);
        return mTitleChar;
    }

    public CharSequence getMessageChar() {
        if((mMessageChar==null || mMessageChar.length()<=0) && (mMessageRes>0))
            mMessageChar = mResources.getString(mMessageRes, mMessageArgs);
        return mMessageChar;
    }

    public Fields2Compat setIndeterminate(boolean indeterminate){
    ...
    public Fields2Compat setStyle(int style){
        mStyle=style;
        return this;
    }
    ...
    public Fields2Compat setAllowCancelable(){
        mCancelable=true;
        return this;
    }
    ...
    public Fields2Compat setView(@LayoutRes int reslayout){
        mRes =reslayout;
        return this;
    }
...
//    }
    ...
    public Fields2Compat setCustomButtonLabel(@StringRes int PositiveButton){
        Fields2Compat r = setButtonLabel(PositiveButton, 0, 0);
        mPositiveShow = true;
        return r;
    }

    public Fields2Compat setCustomButtonLabel(@StringRes int PositiveButton, @StringRes int NegativeButton){
        Fields2Compat r = setButtonLabel(PositiveButton, NegativeButton, 0);
        mPositiveShow = true;
        mNegativeShow = true;
        return r;
    }

    public Fields2Compat setCustomButtonLabel(@StringRes int PositiveButton, @StringRes int NegativeButton, @StringRes int NeutralButton){
        Fields2Compat r = setButtonLabel(PositiveButton, NegativeButton, NeutralButton);
        mPositiveShow = true;
        mNegativeShow = true;
        mNeutralShow = true;
        return r;
    ...
    private Fields2Compat setButtonLabel(@StringRes int... buttons){
    ...
    public Fields2Compat allowCloseOnPositiveClick(){
        mPositiveShow = true;
        return this;
    }

    public Fields2Compat allowCloseOnNegativeClick(){
        mNegativeShow = true;
        return this;
    }

    @Deprecated
    public Fields2Compat setEnableNavigationButtons(){
        mPositiveShow = true;
        mNegativeShow = true;
        return this;
    }
    ...
    public Fields2Compat onRestoreInstanceState(@Nullable Parcelable state) {
